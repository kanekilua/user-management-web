<template>
    <el-container>
        ...
        <el-main>
            ...
            <el-button class="button" type="primary" @click="resetPwd()" round>重置密码</el-button>
        </el-main>
        <el-footer>
            <router-link class="footLeft " to= "AccountLogin"><返回登录</router-link>
